...
public class SwerveSubsystemV2 extends SubsystemBase {
  ...
  public SwerveSubsystemV2() {
    // Initialize hardware
    m_gyro = new Pigeon2(DriveConstants.kPigeonGyroCanId, "swerve");
  ...
  public Pose2d getPose() {
    // TODO: POSE FROM LIMELIGHT/VisionSubsystem
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier angularRotationX)
  {
    return run(() ->
      // Make the robot move
      drive(translationX.getAsDouble(), translationY.getAsDouble(), angularRotationX.getAsDouble(), true));
  }
