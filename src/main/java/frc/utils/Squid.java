...
public class Squid implements Sendable, AutoCloseable {
   ...
   */
  public Squid(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
  ...
  public Squid(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
  ...
  public double calculate(double measurement) {
    ...
    return ((m_kp * m_error)*(Math.abs(m_kp * m_error))) + m_ki * m_totalError + m_kd * m_errorDerivative;
  }
